...
cleanupdirs="$USER_HOME/.kube /.kube /var/lib/kubelet/ /root/.kube /home/.kube /var/lib/etcd /etc/kubernetes /etc/cni /opt/cni /var/lib/cni /var/run/calico /opt/rke /etc/default/kubelet"
...
sudo rm /usr/share/keyrings/kubernetes-apt-keyring.gpg /etc/modules-load.d/k8s.conf
